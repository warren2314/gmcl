...
|---|---|---|
| Managed identity provider | Provider-neutral OIDC Authorization Code + PKCE integration, discovery, verified tokens, key rotation, ACR and step-up are implemented. | Procurement, DPA, provider configuration and recovery support are external (`B-01`, `P-05`, `P-09`). |
