...
CLUB_PORTAL_OIDC_PROVIDER_PROFILE=generic
...
CLUB_PORTAL_COGNITO_POLICY_VERIFIED=false
CLUB_PORTAL_COGNITO_PROVISIONING_ENABLED=false
CLUB_PORTAL_COGNITO_USE_DEFAULT_CREDENTIAL_CHAIN=false
CLUB_PORTAL_COGNITO_AWS_ACCESS_KEY_ID=
CLUB_PORTAL_COGNITO_AWS_SECRET_ACCESS_KEY=
CLUB_PORTAL_COGNITO_AWS_SESSION_TOKEN=
