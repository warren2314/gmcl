...
func TestResponseRequestDraftRequiresCurrentAllegationLinkAndSevenDayWindow(t *testing.T) {
	...
	if err := validateResponseDraftContent("response_request", body, allegation); err != nil {
	...
	for name, invalid := range map[string]string{
		...
		t.Run(name, func(t *testing.T) {
			if err := validateResponseDraftContent("response_request", invalid, allegation); err == nil {
